...
namespace Binaural {
	...
	{						
		...
		channelToListener.PushBack(buffer, sourceTransform.GetPosition(), listenerTransform.GetPosition(), ownerCore->GetAudioState(), ownerCore->GetMagnitudes().GetSoundSpeed());
