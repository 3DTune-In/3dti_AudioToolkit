...
namespace Common {
	...
	*/
	...
	private:
		...
		bool SetCoefsFor_LSelf(double cutoffFreq, double Q, double gain);
		bool SetCoefsFor_HSelf(double cutoffFreq, double Q, double gain);
		bool SetCoefsFor_PeakNoch(double centerFreqHz, double Q, double gain);
